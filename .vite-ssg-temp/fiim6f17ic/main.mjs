import { defineComponent, mergeProps, useSSRContext, withCtx, createVNode, createTextVNode, createApp } from "vue";
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "greetings" }, _attrs))} data-v-a9bae2ec><h1 class="green" data-v-a9bae2ec>${ssrInterpolate(_ctx.msg)}</h1><h3 data-v-a9bae2ec> You’ve successfully created a project with <a href="https://vitejs.dev/" target="_blank" rel="noopener" data-v-a9bae2ec>Vite</a> + <a href="https://vuejs.org/" target="_blank" rel="noopener" data-v-a9bae2ec>Vue 3</a>. </h3></div>`);
    };
  }
});
const HelloWorld_vue_vue_type_style_index_0_scoped_a9bae2ec_lang = "";
...
const HelloWorld = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-a9bae2ec"]]);
const WelcomeItem_vue_vue_type_style_index_0_scoped_fd0742eb_lang = "";
const _sfc_main$7 = {};
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "item" }, _attrs))} data-v-fd0742eb><i data-v-fd0742eb>`);
  ssrRenderSlot(_ctx.$slots, "icon", {}, null, _push, _parent);
  _push(`</i><div class="details" data-v-fd0742eb><h3 data-v-fd0742eb>`);
...
const WelcomeItem = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-fd0742eb"]]);
const _sfc_main$6 = {};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><header data-v-440c393a><img alt="Vue logo" class="logo"${ssrRenderAttr("src", _imports_0)} width="125" height="125" data-v-440c393a><div class="wrapper" data-v-440c393a>`);
      _push(ssrRenderComponent(HelloWorld, { msg: "You did it!" }, null, _parent));
      _push(`</div></header><main data-v-440c393a>`);
      _push(ssrRenderComponent(_sfc_main$1, null, null, _parent));
      _push(`</main><!--]-->`);
    };
  }
});
const App_vue_vue_type_style_index_0_scoped_440c393a_lang = "";
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-440c393a"]]);
